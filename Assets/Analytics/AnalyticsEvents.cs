...
public class AnalyticsEvents : MonoBehaviour
{
  ...
  #if HAS_BYTEBREW_SDK
    ByteBrew.NewProgressionEvent(ByteBrewProgressionTypes.Started, "Level", "", lvl + 1);
  #endif
  }
  void on_level_restarted(int lvl)
  {
    #if HAS_BYTEBREW_SDK
      //ByteBrew.NewProgressionEvent(ByteBrewProgressionTypes.LevelRestart, "Level", "", lvl + 1);
    #endif  
  }
